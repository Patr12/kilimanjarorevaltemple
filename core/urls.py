...
urlpatterns = [
    ...
    path('dashboard/management/roles/', views.role_assignment_dashboard, name='role_assignment_dashboard'),
    path('dashboard/management/roles/<int:profile_id>/edit/', views.role_assignment_edit, name='role_assignment_edit'),
    path('dashboard/management/logs/', views.action_log_dashboard, name='action_log_dashboard'),
    path('dashboard/financial/', views.financial_dashboard, name='financial_dashboard'),
    path('dashboard/financial/zone/', views.zone_leader_dashboard, name='zone_leader_dashboard'),
    path('dashboard/financial/deacon/', views.deacon_leader_dashboard, name='deacon_leader_dashboard'),
    path('dashboard/financial/members/', views.financial_members, name='financial_members'),
    path('dashboard/financial/offerings/', views.financial_offerings, name='financial_offerings'),
    path('dashboard/financial/offerings/<int:offering_id>/edit/', views.financial_offering_edit, name='financial_offering_edit'),
    path('dashboard/financial/contributions/', views.financial_contributions, name='financial_contributions'),
    path('dashboard/financial/contributions/<int:contribution_id>/edit/', views.financial_contribution_edit, name='financial_contribution_edit'),
    path('dashboard/financial/reports/', views.financial_reports, name='financial_reports'),
    path('dashboard/financial/reports/pdf/', views.financial_report_pdf, name='financial_report_pdf'),
    path('dashboard/assets/', views.asset_management, name='asset_management'),
    path('dashboard/assets/<int:asset_id>/edit/', views.asset_edit, name='asset_edit'),
    path('dashboard/family/', views.family_management, name='family_management'),
    path('dashboard/family/<int:family_id>/edit/', views.family_member_edit, name='family_member_edit'),
    ...
    path('offerings/<int:offering_id>/receipt/', views.offering_receipt, name='offering_receipt'),
      # Admin/Staff URLs
